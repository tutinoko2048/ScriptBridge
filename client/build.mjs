...
// add headers
const _js = await readFile('build/script-bridge-client.js', 'utf8');
await writeFile('build/script-bridge-client.js', header + _js);

const _dts = await readFile('build/script-bridge-client.d.ts', 'utf8');
await writeFile('build/script-bridge-client.d.ts', header + _dts);
